# This code works best when I added the margin in cropping and in the current version added the threshold on the similarity and also the email extarction
